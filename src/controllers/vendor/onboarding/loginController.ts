...
export const sendLoginOtp = asyncWrapper(async (req: Request, res: Response) => {
...
export const verifyLoginOtp = asyncWrapper(async (req: Request, res: Response) => {
  ...
  try {
    ...
    const token = jwtService.generateToken({
      id: vendor.id,
      role: 'VENDOR',
      plan: 'FREE', // Defaulting to FREE as plan is not in Vendor model but required by TokenPayload
    })
